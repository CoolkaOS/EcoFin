...
Вопросы по условию можно задавать на протяжении всего тура в ВК нашей группы: https://vk.com/economiccarousel
...
По всем техническим вопросам - vk.com/coolkaos, @CoolkaOS''', parse_mode=telegram.ParseMode.MARKDOWN,
                              reply_markup=markup)
    else:
